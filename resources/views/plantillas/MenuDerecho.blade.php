<ul id="nav-mobile" class="right hide-on-med-and-down">
    <li>        
        ...
        class="waves-effect waves-block waves-light notification-button dropdown-trigger">
            <i class="material-icons">mail_outline 
                <small class="noti-ot">3</small></i>
        </a>
        <ul id="dropdown3" class="dropdown-content" id="notifications-dropdown" tabindex="0">
            ...
            <li tabindex="0"><a class="black-text" href="#!">
    ...
    <li>
        ...
        data-beloworigin="true" 
        class="waves-effect waves-block waves-light notification-button dropdown-trigger">
        <span class="circle responsive-img valign taman-us"
        ><img src="{{ asset('img/person1.jpg') }}" alt=""></span></a>
